...
export default function WhatsAppFloat() {
  ...
  const showText = hovered && !isMobile;
  ...
  return (
    ...
    >
      ...
      {/* Tooltip text on hover — hidden on mobile */}
      {!isMobile && (
        <span
          style={{
            whiteSpace: "nowrap",
      ...
      {/* Pulse ring animation — smaller on mobile */}
      <style>{`
        @keyframes wa-pulse {
          0% { box-shadow: 0 0 0 0 rgba(37, 211, 102, 0.5); }
          70% { box-shadow: 0 0 0 ${isMobile ? "10px" : "18px"} rgba(37, 211, 102, 0); }
